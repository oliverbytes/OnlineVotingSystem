...
defined('THISDS') ? null : define('THISDS', DIRECTORY_SEPARATOR);
defined('THISSITE_ROOT') ? null : define('THISSITE_ROOT', THISDS.'xampp'.THISDS.'htdocs'.THISDS.'Voting System v2');
defined('THISLIBPATH') ? null : define('THISLIBPATH', THISSITE_ROOT.THISDS.'includes');
require_once(THISLIBPATH.THISDS."config.php");
